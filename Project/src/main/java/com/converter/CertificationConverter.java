...
public class CertificationConverter {
	...
	public static CertificationDto toCertificationDto(Certification certification) {
		...
		certificationDto.setFirstName(certification.getEmployee().getLastname());
		certificationDto.setCertificateId(certification.getCertificate().getId());
		certificationDto.setCerificateName(certification.getCertificate().getName());
		certificationDto.setCertificateDescription(certification.getCertificate().getType());
