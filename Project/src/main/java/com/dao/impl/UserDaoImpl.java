...
public class UserDaoImpl implements UserDao {
	...
	public boolean delete(int userId) {
		try {
			...
			System.out.println("Metoda thirretttttttttttttttttttttttttttttt");
			user.setValidity(false);
			System.out.println("Deleting userrrrrrrrrr");
			...
			entityManager.merge(user);
			System.out.println("user deleteddddddddddddddddddddddddddddddddddddddddddddd");
...
System.out.println("thirret metoda ne daooooooooooooooooooooooooo");
		User user = null;
		try {
			...
			System.out.println("Useriiiii u morrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr");
			System.out.println(user.getEmail()+"emailii");
